      ...
      <div className='cate-info'>
        ...
        <div className='cate-images'>
          <div className='cate-img'>
            <img className='category' src='path/to/dining-image.jpg' alt='Dining' />
            <p className='cate-name'>Dining</p>
          </div>
          <div className='cate-img'>
            <img className='category' src='path/to/living-image.jpg' alt='Living' />
            <p className='cate-name'>Living</p>
          </div>
          <div className='cate-img'>
            <img className='category' src='path/to/bathroom-image.jpg' alt='Bathroom' />
